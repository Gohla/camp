 ...
 */
inline void serialize(const UserObject& object, xercesc::DOMElement* node, const Args& tags = Args::empty,
    bool include = false, bool throwExceptions = true)
{
    detail::serialize<detail::Xerces>(object, node, tags, include, throwExceptions);
}
