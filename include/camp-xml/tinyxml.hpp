 ...
 */
inline void serialize(const UserObject& object, TiXmlElement* node, const Args& tags = Args::empty,
    bool include = false, bool throwExceptions = true)
{
    detail::serialize<detail::TinyXml>(object, node, tags, include, throwExceptions);
}
